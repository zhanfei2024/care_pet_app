...
class ScaleLayer extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final CustomPoint<num> start = map.project(center);
    final LatLng targetPoint =
        util.calculateEndingGlobalCoordinates(center, 90, distance);
    final CustomPoint<num> end = map.project(targetPoint);
...
class ScalePainter extends CustomPainter {
  ...
  void paint(ui.Canvas canvas, ui.Size size) {
    ...
    final num paddingLeft = padding == null ? 0 : padding.left + sizeForStartEnd / 2;
